...
<table align="center">
		...
		<c:if test="${user.role=='manager'}">
			...
			<table border="1" bordercolor="#ECECEC" cellspacing="0"
				...
				<c:forEach items='${users}' var='user'>
					<tr>
						<td><html:link style = "text-decoration:none" action="/EditUser" paramId="id"
		...
		<table border="1" bordercolor="#ECECEC" cellspacing="0"
			...
			<c:forEach items='${projects}' var='project'>
				...
				<tr align="center" class="${even?'bglo':'bghi'}">
					<td><html:link style = "text-decoration:none" action="/OnePageProject" paramId="id"
					...
					<c:if test="${user.role=='project manager'}">
						<td><html:link style = "text-decoration:none" action="/EditProjectHeader" paramId="id"
							paramName="project" paramProperty="id">
	    [ EDIT ]</html:link></td>
					</c:if>
	...
	<tr align="center"><c:if test="${empty projects}">
